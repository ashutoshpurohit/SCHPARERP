...
/*
        getSupportFragmentManager().beginTransaction()
            .add(R.id.calendar_detail_container, fragment)
            .addToBackStack(null)
...
*/
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CalendarEventFragment(), "Events");
        adapter.addFragment(new CalendarHolidayEventFragment(), "Holidays");
